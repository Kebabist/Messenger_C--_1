...
void loggedinpage::addtopage(){
    try{
       ...
       for (std::size_t i = 0; i < repos.size(); ++i) {
        ...
        qDebug() << "Unknown exception caught in addtopage";
    }
}
...
{   try{
        ...
        qDebug() << "Unknown exception caught in on_joingroupbutton_clicked";
    }
}
//create group button
...
{   try{
        ...
        qDebug() << "Unknown exception caught in on_creategroupbutton_clicked";
    }
}
...
{   try{
        ...
        qDebug() << "Unknown exception caught in on_joinchannelbutton_clicked";
    }
}
...
{   try{
        ...
        qDebug() << "Unknown exception caught in on_creatchannelbutton_clicked";
    }
}
...
{   try{
        ...
        qDebug() << "Unknown exception caught in on_newchatbutton_clicked";
    }
}
...
{   try{
        ...
        qDebug() << "Unknown exception caught in on_sendmessagebutton_clicked";
    }
}
...
void loggedinpage::closeEvent(QCloseEvent *event) {
    ...
    qDebug() << "Unknown exception caught in closeEvent";
    }
}
